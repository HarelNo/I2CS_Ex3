 ...
 * 4. Your are asked to implement the following classes: PacMan.Index2D, PacMan.Map, PacMan.Ex3Algo.
...
public class Ex3Main {
    ...
    public static void play1() {
        ...
        while(ex3.getStatus()!=PacmanGame.DONE) {
            ...
            if (_cmd != null && _cmd == 'h') {
            	System.out.println("Pacman help: keys: ' '-start, 'w,a,x,d'-directions, all other parameters should be configured via PacMan.GameInfo.java, ");
            }
